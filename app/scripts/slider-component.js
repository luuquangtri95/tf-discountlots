const customElementsName = 'slider-component';
!window.customElements.get(customElementsName) &&
    window.customElements.define(customElementsName, class extends HTMLElement {
        ...
        connectedCallback() {
            ...
            if (this.hasAttribute('slide-wait')) return;
            this.createSlide();
        }
        ...
        createSlide() {
            if (this.slider || !this.querySelector('.js-slider').childElementCount) return;
        ...
        onInit() {
            ...
            const emptySlides = [...this.querySelectorAll('.swiper-slide')].filter(slide => {
                const emptyContent = slide.querySelector('.swiper-slide-content-empty');
                return !!emptyContent;
            });
        ...
        unLoad() {
            if (!this.slider || !this.slider.destroy) return;
            this.slider.destroy();
        }
