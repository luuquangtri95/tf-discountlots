(() => {
  // app/scripts/video-component.js
  !window.customElements.get("video-component") && window.customElements.define(
    "video-component",
    class extends HTMLElement {
      ...
      togglePlay() {
        ...
        this.hasAttribute("play-in-view") && inViewPort(this, (e) => {
      ...
      loadYoutubeVideo() {
        ...
        function onPlayerReady(event) {
          let video2 = event.target;
          const iframe = video2.getIframe();
          if (!container.hasAttribute("play-in-view"))
            return;
          video2.mute();
          video2.playVideo();
        }
      ...
      loadVimeoVideo() {
        ...
        container.hasAttribute("play-in-view") && (video.media.setVolume(0), video.media.play());
        this.videoPlay = () => {
          video.media.play();
        };
        this.videoStop = () => {
    ...
    class extends HTMLElement {
      ...
      init() {
        this.querySelector("button").addEventListener("click", () => {
          ...
          this.closest(".wrapper-component-video")?.querySelector("video-component")?.playVideo?.();
        });
      }
    }
  );
