    ...
    window.customElements.define(
      ...
      class extends HTMLElement {
        ...
        init() {
          ...
          if (this.close) {
            this.close.closest("details") == this.details &&
        ...
        changeState() {
          this.hasAttribute("data-open-screen") &&
            window.matchMedia(this.getAttribute("data-open-screen")).matches &&
            (this.querySelector("details").open = true);
          this.hasAttribute("data-close-screen") &&
            window.matchMedia(this.getAttribute("data-close-screen")).matches &&
